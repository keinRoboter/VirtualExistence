                ...
                switch (event.type) {
                    ...
                    case 'touchmove':
                        ...
                        if (swipeFunc.touches.touchstart.y > -1 && swipeFunc.touches.touchmove.y > -1) {
                            ...
                            direccion = swipeFunc.touches.direction;
                            advancenn = (swipeFunc.touches.touchstart.y - swipeFunc.touches.touchmove.y)
                            }
                        break;
                    case 'touchend':
...
window.addEventListener('touchmove', function(event)
{
 ...
 {
  preventDefault(event);
  //alert('going'+direccion);
  //preventDefaultForScrollKeys(event);
 }
 else if (direccion == "bottom")
 {
